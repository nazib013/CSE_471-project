...
const CATEGORIES = ["All", "Nutrition", "Health", "Grooming", "Training", "Behavior"];
  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", alignItems: "center", gap: "10px", flexWrap: "wrap" }}>
        ...
        {formattedDate && (
          <span style={styles.dateChip}>📅 {formattedDate}</span>
        )}
      </div>
...
=======
      try {
        ...
        if (!res.ok) { setTips([]); setFilteredTips([]); return; }
...
=======
          ...
          <div style={styles.searchWrap}>
            ...
            {search && (
              <button
                onClick={() => { setSearch(""); setFilteredTips(tips); }}
